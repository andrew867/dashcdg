 ...
 *    void
 */
static void D_plsf_3( D_plsfState *st, enum ModeNB mode, Word16 bfi, Word16 *
 ...
 *    void
 */
static void Build_CN_param( Word16 *seed, enum ModeNB mode, Word16 parm[] )
{
   Word32 i;
   const Word32 *p;
...
static void dtx_dec( dtx_decState *st, Word32 *mem_syn, D_plsfState *lsfState,
      ...
      DTXStateType new_state, enum ModeNB mode, Word16 parm[], Word32 synth[],
      Word32 A_t[] )
{
 ...
 *    void
 */
static void gc_pred( gc_predState *st, enum ModeNB mode, Word32 *code, Word32 *
 ...
 *    void
 */
static void Dec_gain( gc_predState *pred_state, enum ModeNB mode, Word32 index,
 ...
 *    void
 */
static void d_gain_code( gc_predState *pred_state, enum ModeNB mode, Word32 index,
 ...
 *    void
 */
static Word32 Cb_gain_average( Cb_gain_averageState *st, enum ModeNB mode, Word32
 ...
 *    void
 */
static void ph_disp( ph_dispState *state, enum ModeNB mode, Word32 x[],
 ...
 *    void
 */
static void Decoder_amr( Decoder_amrState *st, enum ModeNB mode, Word16 parm[],
 ...
 *    void
 */
static void Post_Filter( Post_FilterState *st, enum ModeNB mode, Word32 *syn,
      Word32 *Az_4 )
{
 ...
 *    void
 */
void Speech_Decode_Frame( void *st, enum ModeNB mode, Word16 *parm, enum
...
int Speech_Decode_Frame_reset( void **st )
{
   ...
   Decoder_amr_reset( state->decoder_amrState, ( enum ModeNB ) 0 );
