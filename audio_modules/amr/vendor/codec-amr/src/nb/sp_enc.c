 ...
 *
 */
static void lpc( Float32 *old_A, Float32 x[], Float32 x_12k2[], Float32 a[], enum ModeNB
      mode )
{
   Word32 i;
   Float32 r[MP1];
 ...
 *    void
 */
static void Q_plsf_3( enum ModeNB mode, Float32 *past_rq, Float32 *lsp1, Float32 *
 ...
 */
static Word16 q_gain_pitch( enum ModeNB mode, Float32 gp_limit, Float32 *gain,
 ...
 *    void
 */
static void gc_pred( Word32 *past_qua_en, enum ModeNB mode, Float32 *code,
...
static Word16 tx_dtx_handler( Word16 vad_flag, Word16 *decAnaElapsedCount,
      Word16 *dtxHangoverCount, enum ModeNB *used_mode )
{
 ...
 *    void
 */
static void cod_amr( cod_amrState *st, enum ModeNB mode, Float32 new_speech[],
      Word16 ana[], enum ModeNB *used_mode, Float32 synth[] )
{
   /* LPC coefficients */
