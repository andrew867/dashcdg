...
For the latest release snapshot, see `[releases/v0.4.0.md](releases/v0.4.0.md)`.
...
| `[plans/esp32-badge-perf-realtime-implementation-tranches.md](plans/esp32-badge-perf-realtime-implementation-tranches.md)` | **ESP32 badge** — perf program T0–T11, files + thread context per tranche                                                 |
...
| `[specs/esp32-badge-perf-realtime-spec.md](specs/esp32-badge-perf-realtime-spec.md)`                                       | **ESP32 badge** — perf/real-time findings, mutex/blit evidence, metrics §, grep gates                                     |
...
| `[test/esp32-badge-perf-realtime-test-plan.md](test/esp32-badge-perf-realtime-test-plan.md)`         | **ESP32 badge** — perf/real-time program: `BLD-`*, `KAR-*`, `MTX-*`, soak gates                 |
| Other `test/*.md`                                                                                    | Feature‑specific plans and reports                                                              |


## Hardware, embedded & ops

- **ESP32 badge perf & real-time (2026):** [master index](plans/esp32-badge-perf-realtime-master-index.md) — `[specs/esp32-badge-perf-realtime-spec.md](specs/esp32-badge-perf-realtime-spec.md)`, `[plans/esp32-badge-perf-realtime-implementation-tranches.md](plans/esp32-badge-perf-realtime-implementation-tranches.md)`, `[test/esp32-badge-perf-realtime-test-plan.md](test/esp32-badge-perf-realtime-test-plan.md)` (`badge_rx.c`, `karaoke_ui.c`, `platform_hw.c`, `core/src/audio_jitter.c`).
