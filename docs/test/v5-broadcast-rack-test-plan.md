...
| V5-BR-CLK-06 | License / SBOM | Release audit | `git grep` / build manifest | **No** GPL **ESP1588** sources in tree; **MIT** `third_party/` (**IEEE1588-PTP**, **flexPTP**) **LICENSE** files present; desktop slave glue project-licensed |
